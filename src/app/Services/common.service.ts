...
export class CommonService {
  ...
  loginData = new Subject(); // hold all the permission of the logged in user
  sessonTime = new BehaviorSubject(30);
  useCurrency = new Subject();
  constructor(private spinner: NgxSpinnerService, private toastr: ToastrService, private routes: Router) {
  ...
  getPermission(menu, subMenu) {
    ...
    if (permission[menu].includes(subMenu)) {
      return true
    } else {
      return false
    }
