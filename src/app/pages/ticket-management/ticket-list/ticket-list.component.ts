...
export class TicketListComponent implements OnInit {
  ...
  total : any
  currentPage = 1
 adminList : any  = [{userName : 'Mr. Sub Admin',email : 'subadmin@finvo.com',updatedAt : new Date(),message : 'Loream Ipsum',status : 'Resolved'}]
 selectAll : any
  ...
  viewAdmin(id){
    this.router.navigate(["/ticket/ticket-view"],{queryParams : {id}})
  }
  editAdmin(id){
