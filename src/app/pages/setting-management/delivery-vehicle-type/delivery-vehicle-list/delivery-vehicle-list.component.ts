...
@Component({
  ...
  styleUrls: ['./delivery-vehicle-list.component.css']
})
export class DeliveryVehicleListComponent implements OnInit {
  action : any = 0
  deleteServiceId : any = []
  timer : any
  search:any
...
openBulkDeleteModal(){
  ...
  // delete product
  deleteService(){
    let url = `admin/deleteManyVehicle`
    let data = {
        "vehicleId": this.deleteServiceId
    }
...
editVehicle(id){
  this.router.navigate(['setting/delivery-vehicle-edit'],{queryParams:{id:id}})
}
